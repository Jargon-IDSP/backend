...
CREATE TABLE `flashcards` (
    ...
    `definitionMandarin` TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE `flashcards` ADD CONSTRAINT `flashcards_industryId_fkey` FOREIGN KEY (`industryId`) REFERENCES `industries`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
